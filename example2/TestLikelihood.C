...
void TestLikelihood() {
    ...
    likelihood.Init(10000,10000,10.0);
    ...
    params[SystematicCorrection::kSignalWeight] = 1000;
    params[SystematicCorrection::kBackgroundWeight] = 1000.0;
    ...
    params[SystematicCorrection::kSignalWeight] = 500.0;
    likelihood.FillHistograms(params);
    simStack = new THStack("simStack", "Signal 500");
    simStack->Add(likelihood.SimulatedDecayTag);
    simStack->Add(likelihood.SimulatedSeparated);
    simStack->Add(likelihood.SimulatedClose);
    simStack->Draw();
    ...
    params[SystematicCorrection::kSignalWeight] = 1500.0;
    likelihood.FillHistograms(params);
    simStack = new THStack("simStack", "Signal 1500");
    simStack->Add(likelihood.SimulatedDecayTag);
    simStack->Add(likelihood.SimulatedSeparated);
    simStack->Add(likelihood.SimulatedClose);
    simStack->Draw();
    ...
    params[SystematicCorrection::kBackgroundWeight] = 500.0;
    likelihood.FillHistograms(params);
    simStack = new THStack("simStack", "Background 500");
    simStack->Add(likelihood.SimulatedDecayTag);
    simStack->Add(likelihood.SimulatedSeparated);
    simStack->Add(likelihood.SimulatedClose);
    simStack->Draw();
    ...
    params[SystematicCorrection::kBackgroundWeight] = 1500.0;
    likelihood.FillHistograms(params);
    simStack = new THStack("simStack", "Background 1500");
    simStack->Add(likelihood.SimulatedDecayTag);
    simStack->Add(likelihood.SimulatedSeparated);
    simStack->Add(likelihood.SimulatedClose);
    simStack->Draw();
